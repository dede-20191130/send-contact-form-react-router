...
import {
    createTextForAccepttedContent, createTextBlob, SubmitIndicator
...
describe('createTextForAccepttedContent', () => {
    ...
    it('should create text according to props', () => {
        ...
        // mock date
        spyedDateNow = jest.spyOn(Date, "now").mockImplementation(() => 1626706800000)
        ...
        expect(new RegExp("【ご意見内容】[\\s\\S]*" + input.message).test(text)).toBe(true);
...
describe('SubmitIndicator', () => {
    ...
    beforeEach(() => {
        ...
        render(<SubmitIndicator formValues={data} onCloseModal={onCloseModal} />)
    ...
    it('should prepare anchor link when calling download', () => {
        ...
        // DL button click
        fireEvent.click(screen.getByRole("button", { name: "送信内容のダウンロード" }));

        expect(HTMLAnchorElement.prototype.click).toHaveBeenCalledTimes(1);

        // restore
        (HTMLAnchorElement.prototype.click as jest.Mock<any, any>).mockRestore();
